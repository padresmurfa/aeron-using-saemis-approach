...
- [`Darasel`](../../high_abstractions/darasel.md): the Primal Language; the ordered totality of first meanings contained within being.
- [`Daralon`](../../era_names/daralon.md): Inflationary Era; widening age of durable domains.
- [`Darathen`](../../era_names/darathen.md): Dark Ages; age of luminous silence and existential solitude.
- [`Daravel`](../../structural_principles/daravel.md): Impulse Bearers; outward carriers of structured differentiation.
- [`Daravelon`](../../era_names/daravelon.md): Reionization Era; age of first stellar ignition and outward-borne created radiance.
